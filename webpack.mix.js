 ...
 * build style
 */
mix.less('./src/styles/my-iview.less','./test/',{relativeUrls:false})
	.sass('./src/styles/index.scss','./test/')
	.styles(['test/my-iview.css','test/index.css'],`dist/styles/${outStyleFilename}`);

mix.js('./src/main.js',`./dist/${outScriptFilename}`).sourceMaps();
...
// mix.sass(src, output);
// mix.less(src, output, config); mix(src,output,{relativeUrls:false}) relativeUrls:使用相对URL
